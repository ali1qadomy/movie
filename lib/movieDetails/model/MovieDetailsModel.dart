import 'dart:convert';
/// adult : false
/// backdrop_path : "/7h1NlsHPsgZ0T6btQo3T1VQH7YZ.jpg"
/// belongs_to_collection : {"id":730288,"name":"Black Hills Collection","poster_path":"/t1sglvSVRtcbYPGuhN0MFi0Z1SR.jpg","backdrop_path":"/3M0qplaoenTN5xN66uUWHfge77x.jpg"}
/// budget : 0
/// genres : [{"id":18,"name":"Drama"},{"id":37,"name":"Western"},{"id":12,"name":"Adventure"}]
/// homepage : ""
/// id : 5036
/// imdb_id : "tt0063798"
/// original_language : "de"
/// original_title : "Weisse Wölfe"
/// overview : "Farsighted Falcon, chief of the Lakota, seeks refuge in the Black Hills with his wife Blue Hair and two warriors, sole survivors of their tribe. When they are attacked by the outlaw Bashan, Falcon strikes out for the town of Tanglewood to take on Bashan's boss, mining magnate Harrington."
/// popularity : 0.976
/// poster_path : "/ja6Uxh0vhCOHb3IU8V2jNvhl2VT.jpg"
/// production_companies : [{"id":602,"logo_path":"/pVsXRFbYVDe5BhsATCAh1rt5F0k.png","name":"DEFA","origin_country":"DE"},{"id":10617,"logo_path":null,"name":"Bosna Film","origin_country":"BA"}]
/// production_countries : [{"iso_3166_1":"XG","name":"East Germany"},{"iso_3166_1":"YU","name":"Yugoslavia"}]
...
MovieDetails mvoieDetailsFromJson(String str) => MovieDetails.fromJson(json.decode(str));
String mvoieDetailsToJson(MovieDetails data) => json.encode(data.toJson());
class MovieDetails {
  MovieDetails({
    bool? adult,
    String? backdropPath,
